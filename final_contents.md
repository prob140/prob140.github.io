...
### Probability ###
- [Chapter 1](http://prob140.org/textbook/content/Chapter_01/00_Fundamentals.html): Spaces, events, basic counting (but the exponential approximation is not in scope)
...
- [Chapter 5](http://prob140.org/textbook/content/Chapter_05/00_Collections_of_Events.html): Unions and intersections of several events (but the inclusion-exclusion formula is not in scope)
...
- [Chapter 4](http://prob140.org/textbook/content/Chapter_04/00_Relations_Between_Variables.html): Joint distribution (discrete case)
- Section [5.3](http://prob140.org/textbook/content/Chapter_05/03_The_Matching_Problem.html), [5.4](http://prob140.org/textbook/content/Chapter_05/04_Sampling_Without_Replacement.html): Random permutations and symmetry (but the distribution of the number of matches is out of scope)
- Section [15.1](http://prob140.org/textbook/content/Chapter_15/01_Density_and_CDF.html), [15.2](http://prob140.org/textbook/content/Chapter_15/02_The_Meaning_of_Density.html): Density
- Section [6.1](http://prob140.org/textbook/content/Chapter_06/01_Binomial_Distribution.html#cumulative-distribution-function-cdf), [15.1](http://prob140.org/textbook/content/Chapter_15/01_Density_and_CDF.html): cumulative distribution function (cdf)
- [Section 16.1](http://prob140.org/textbook/content/Chapter_16/01_Linear_Transformations.html), [16.2](http://prob140.org/textbook/content/Chapter_16/02_Monotone_Functions.html): Densities of transformations
...
- Section [14.3](http://prob140.org/textbook/content/Chapter_14/03_Central_Limit_Theorem.html), [14.5](http://prob140.org/textbook/content/Chapter_14/05_The_Sample_Mean.html), Section [15.3](http://prob140.org/textbook/content/Chapter_15/03_Expectation.html#example-random-discs): Random sample sums and averages; Central Limit Theorem
...
- Section [12.3](http://prob140.org/textbook/content/Chapter_12/03_Bounds.html): Bounds: Markov, Chebyshev
...
### Variance ###
- [Chapter 12](http://prob140.org/textbook/content/Chapter_12/00_Standard_Deviation.html): Definition and basic properties; linear transformations (but heavy tails are out of scope)
- [Chapter 13](http://prob140.org/textbook/content/Chapter_13/00_Variance_Via_Covariance.html): Covariance; variance of a sum
- Section [24.2](http://prob140.org/textbook/content/Chapter_24/02_Bivariate_Normal_Distribution.html), Homework 8, Lab 4: Correlation and its properties
- Section [22.3](http://prob140.org/textbook/content/Chapter_22/03_Variance_by_Conditioning.html), [22.4](http://prob140.org/textbook/content/Chapter_22/04_Examples.html): Variance by conditioning
...
- Homework 9, Homework 15: Unbiased estimator of a population variance; independence of normal sample mean and sample variance
- Section [20.3](http://prob140.org/textbook/content/Chapter_20/03_Prior_and_Posterior.html#), [21.1](http://prob140.org/textbook/content/Chapter_21/01_Updating_and_Prediction.html): Posterior density, MAP estimate, conjugate prior
...
- Chapter [24](http://prob140.org/textbook/content/Chapter_24/00_Simple_Linear_Regression.html): Least squares linear predictor

## Special Distributions ##
Though moment generating functions are out of scope, they were used for establishing fundamental properties of distributions. The references to Chapter 19 below are for those properties, not their derivation.
...
### Normal ###
- Section [14.3](http://prob140.org/textbook/content/Chapter_14/03_Central_Limit_Theorem.html): CLT; Normal cdf and inverse cdf
...
- Section [18.1](http://prob140.org/textbook/content/Chapter_18/01_Standard_Normal_Basics.html), [18.2](http://prob140.org/textbook/content/Chapter_18/02_Sums_of_Independent_Normal_Variables.html), : Independent normal variables, linear combinations, squares, Rayleigh
- Section [24.2](http://prob140.org/textbook/content/Chapter_24/02_Bivariate_Normal_Distribution.html), [24.3](http://prob140.org/textbook/content/Chapter_24/03_Regression_and_Bivariate_Normal.html): Bivariate normal, linear combinations, independence, regression
- [Chapter 23](http://prob140.org/textbook/content/Chapter_23/00_Multivariate_Normal_RVs.html): Multivariate normal, linear combinations, independence, regression (but multivariate normal density function is out of scope)
...
- Section [18.3](http://prob140.org/textbook/content/Chapter_18/03_The_Gamma_Family.html), 
[19.2](http://prob140.org/textbook/content/Chapter_19/02_Moment_Generating_Functions.html#mgf-of-a-gamma-r-lambda-random-variable): Sums of independent gammas with the same rate
- Lab 6: Waiting times of arrivals in a Poisson process